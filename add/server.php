...
$query ="INSERT INTO info(down_Date,down_Time,up_Date,up_Time,category,site,sector,fiber_Vendor,link_Between,information_Source,reason,specific_reason,inform_time,inform_type,
 informed_Vendor,incident_Time,informOfType,informed_Person,inform_TimeonResolve,Type_Of_inform,informedToPerson,noc_DutyEngineer)VALUES('$down_Date','$down_Time','$up_Date', '$up_Time','$category','$site','$sector','$fiber_Vendor','$link_Between','$information_Source','$reason','$specific_reason','$inform_time','$inform_type','$informed_Vendor','$incident_Time', '$informOfType','$informed_Person','$inform_TimeonResolve','$Type_Of_inform','$informedToPerson','$noc_DutyEngineer')";
...
if(isset($_POST['update'])){
 ...
 mysqli_query($conn,"UPDATE info SET * WHERE id=$id");
